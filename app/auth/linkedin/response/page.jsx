...
const LinkedInAuthResponsePage = () => {
  ...
  usePageTitle({ title: translations.LINKED_IN_AUTH_RESPONSE.TITLE })
  ...
  return <COMMON_COMPONENTS.LoaderFullScreen message={translations.LINKED_IN_AUTH_RESPONSE.MESSAGE} />
}

export default LinkedInAuthResponsePage;