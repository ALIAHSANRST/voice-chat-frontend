    ...
    <div className="voice-chat-container">
      ...
      {!isJoined && (
        <div className="call-button-container">
          <COMMON_COMPONENTS.CallButton onClick={joinChannel} text={'Start Audio Chat'} />
        </div>
      )}

      {isJoined && (
        <div className="controls-container">
          <COMMON_COMPONENTS.VideoControls />
          <COMMON_COMPONENTS.MuteButton onClick={toggleMute} isMuted={isMuted} />
